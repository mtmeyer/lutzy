  ...
  return (
    <label class="relative inline-flex cursor-pointer items-center gap-2">
      <ToggleButton
        ...
        class="data-[disabled]:cursor-not-allowed data-[disabled]:opacity-40"
      >
        {state => (
          <div
            class="h-5 w-9 rounded-full bg-surface-3 transition-colors after:absolute after:top-0.5 after:left-0.5 after:h-4 after:w-4 after:rounded-full after:bg-white after:shadow-sm after:transition-all"
            classList={{
